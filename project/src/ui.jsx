...
const CV_CONTENT = {
  hotellerie: {
    fr: {
      ...
      about: "8 ans en hôtellerie de luxe et palaces. Quadrilingue, sens aigu du service VIP. Reconnue pour transformer chaque arrivée en moment d'exception et fidéliser la clientèle internationale.",
      exp: [
        { role: "Chef de réception", company: "Le Bristol Paris · Palace 5★", dates: "2023 — 2025", bullets: ["Management équipe de 6 réceptionnistes 24/7", "Accueil VIP : célébrités, chefs d'État, familles royales", "Satisfaction client 4,9/5 sur 18 mois", "Coordination housekeeping + room service"] },
        { role: "Réceptionniste de nuit", company: "Hôtel Saint-Régis · Paris", dates: "2021 — 2023", bullets: ["Conciergerie premium 24/7, +120 chambres", "Gestion arrivées tardives, plaintes VIP", "Formation Forbes Travel Guide validée"] },
      ...
      edu: [
        { title: "Master Management Hôtelier International", school: "Ferrandi Paris", dates: "2018 — 2020" },
        { title: "Licence Pro Hôtellerie Internationale", school: "Université Paris Dauphine", dates: "2016 — 2018" },
      ],
      skills: ["Accueil VIP", "Opera PMS", "Mews", "Conciergerie luxe", "Management équipe", "Vente additionnelle", "Protocole diplomatique", "Gestion budgétaire"],
      langs: [["Français", "C2", 1.0], ["Anglais", "C2", 1.0], ["Espagnol", "C1", 0.85], ["Italien", "B2", 0.65]],
    ...
    es: {
      ...
      about: "8 años en hotelería de lujo y palacios. Cuatrilingüe, sentido agudo del servicio VIP. Reconocida por transformar cada llegada en un momento de excepción y fidelizar la clientela internacional.",
      exp: [
        { role: "Jefa de recepción", company: "Le Bristol París · Palace 5★", dates: "2023 — 2025", bullets: ["Gestión equipo de 6 recepcionistas 24/7", "Acogida VIP: celebridades, jefes de Estado, familias reales", "Satisfacción cliente 4,9/5 durante 18 meses", "Coordinación housekeeping + room service"] },
        { role: "Recepcionista de noche", company: "Hôtel Saint-Régis · París", dates: "2021 — 2023", bullets: ["Conserjería premium 24/7, +120 habitaciones", "Gestión llegadas tardías, reclamaciones VIP", "Formación Forbes Travel Guide validada"] },
      ...
      edu: [
        { title: "Máster Gestión Hotelera Internacional", school: "Ferrandi París", dates: "2018 — 2020" },
        { title: "Licenciatura Pro Hotelería Internacional", school: "Universidad Paris Dauphine", dates: "2016 — 2018" },
      ],
      skills: ["Acogida VIP", "Opera PMS", "Mews", "Conserjería de lujo", "Gestión de equipo", "Venta adicional", "Protocolo diplomático", "Gestión presupuestaria"],
      langs: [["Francés", "C2", 1.0], ["Inglés", "C2", 1.0], ["Español", "C1", 0.85], ["Italiano", "B2", 0.65]],
